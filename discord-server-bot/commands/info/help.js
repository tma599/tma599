  ...
  async execute(interaction) {
    const helpEmbed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '\n🚫 NGワード管理 (要: サーバーの管理権限)', value: ' ' },
        {
          name: '/ngword action:<操作> word:<単語>',
          value: 'NGワードの追加、削除、一覧表示などを行います。',
        },
        { name: '🔒 リアクションロール管理 (要: サーバーの管理権限)', value: ' ' },
        {
          name: '/reactionrole action:<操作>',
          value:
            'リアクションにロールを紐付けて、リアクションの追加/削除でロールを自動的に付与/削除します。',
        },
        { name: '\n⚠️ ご利用上の注意', value: ' ' },
        {
          name: '🚨【重要】権限の設定',
